    ...
    <div style={{ padding: "1rem", color: "#fff", background: "#1a1a1a", fontFamily: "Arial, sans-serif" }}>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: "1rem" }}>
        ...
        <div style={{ flex: "1 1 300px" }}>
          <h2>Creatures</h2>
          {creatures.map((c, i) => (
            <div key={i} style={{ marginBottom: "0.5rem", background: "#2a2a2a", padding: "0.5rem", borderRadius: "6px" }}>
              <strong style={{ color: "#fff" }}>{c.name}</strong>: +{c.counters}/+{c.counters}
              <div>
          ...
          <button onClick={clearAllCreatures} style={{ width: "100%", marginTop: "1rem", background: "#500", color: "#fff", padding: "0.5rem", border: "none", borderRadius: "6px" }}>
            ❌ Clear All Creatures
          </button>
        </div>
      </div>
      ...
      <div style={{ marginTop: "2rem" }}>
        ...
        />
        <button onClick={calculateETB} style={{ width: "100%", marginTop: "0.5rem", padding: "0.5rem" }}>
          Summon Vrestin
        </button>
      ...
      <div style={{ marginTop: "2rem" }}>
        <button onClick={handleCombat} style={{ width: "100%", padding: "0.5rem" }}>
          Attack with Insects
        </button>
        <button onClick={handleEndStep} style={{ width: "100%", marginTop: "0.5rem", padding: "0.5rem" }}>
